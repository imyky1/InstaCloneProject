...
export default function FollowingPost() {
    ...
    useEffect(() => {                //side effect to load all the post everytime page reloads
        async function fetchdata() {
            const res = await axios.get('http://localhost:3000/followingpost', {
                headers: {
    ...
    const handleCloseNavMenu = (postId) => {                 //function to close the menu of post
    ...
    const handleExpandClick = () => {                        //function to open/close comments
